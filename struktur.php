...
if($op == 'delete'){
    $id  = $_GET ['id'];
    $sql1 = "delete from struktur where id = '$id'";
...
if ($op == 'edit') {
    $id = $_GET['id'];
    $sql1 = "select * from struktur where id = '$id'";
    $q1 = mysqli_query($koneksi, $sql1);
...
if (isset($_POST['submit'])) {
    ...
    mysqli_query($koneksi, "insert into struktur set file='$gambar'");
    $sukses = "Berhasil memasukan data baru";

    if ($gambar) {//update
        if ($op == 'edit') {
            $sql1 = "update struktur set gambar = '$gambar' where id = '$id'";
            $q1 = mysqli_query($koneksi, $sql1);
            if ($q1) {
            ...
            $sql1 = "insert into struktur(id,gambar) values ('$id','$gambar')";
            $q1 = mysqli_query($koneksi, $sql1);
            if ($q1) {
                $sukses = "Berhasil memasukan data baru";
            } else {
                        ...
                        <div class="card-body">
                            ...
                            <form action=" " method="POST" enctype="multipart/form-data">
                                <div class="form-group">
                                    <label for="gambar">Gambar Struktur Kecamatan</label>
