...
<body>
    ...
    <header id="header" class="fixed-top d-flex align-items-center text-white" style="background-color: #37517e;">
        <div class="container d-flex align-items-center">
            ...
            <?php include_once("../halaman_depan/navbar2.php"); ?>   
        ...
        <div class="container" style="margin-top: 25px;">
            <div class="row">
                ...
                <div class="col-sm-8 animate__animated animate__fadeInTopLeft animate__slow 2s">
                    <div class="col-sm-12">
                    <?php 
                     $query = "SELECT * FROM kondisi WHERE id='$id'";
                     ...
                     while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        <h2><?php echo $row ['kondisi'];?></h2>
                        <hr />
                        <small><i class="icofont-ui-calendar"></i> Tanggal: 05 Sep 2022 03:59:00</small>
                        <br>
                        <br>
                        <?php echo $row ['isi'];?>
                        </div>
