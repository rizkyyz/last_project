...
if (isset($_SESSION['user_id']) && isset($_SESSION['user_email'])) {
    ...
    //cek jumlah semua masing masing data 
    $data_berita = mysqli_query($koneksi, "SELECT * FROM berita");
    $jumlah_berita = mysqli_num_rows($data_berita);
    $data_layanan = mysqli_query($koneksi, "SELECT * FROM layanan");
    $jumlah_layanan = mysqli_num_rows($data_layanan);
    $data_galery = mysqli_query($koneksi, "SELECT * FROM galery");
    $jumlah_galery = mysqli_num_rows($data_galery);
    $data_pengaduan = mysqli_query($koneksi, "SELECT * FROM pengaduan");
    $jumlah_pengaduan = mysqli_num_rows($data_berita);
    $data_pengunjung = mysqli_query  ($koneksi, "SELECT * FROM pengunjung");
    ...
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Dashboard Telaga Asih</h1>
        </div>
            ...
            <div class="col-xl-3 col-md-6 mb-4">
                <div class="card border-left-info shadow h-100 py-2">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Pengaduan
                                </div>
                                <div class="row no-gutters align-items-center">
                                    <div class="col-auto">
