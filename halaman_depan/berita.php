                        ...
                        <div class="col-sm-12">
                            <div class="card" style="max-width: 550px;">
                                <div class="row no-gutters">
                                    ...
                                    <div class="col-md-4">
                                        <img src="../foto/<?php echo $d['gambar']?>" class="card-img" alt="...">
                                    </div>
                                    <div class="col-md-8">
                                        <div class="card-body">
                                            <h5 class="card-title"><?php echo$d['title']?></h5>
                                            <p class="card-text"><?php echo$d['halaman']?></p>
                                            <p class="card-text"><small class="text-muted"><?php echo$d['tanggal']?></small></p>
                                        </div>
                                    </div>
                                </div>
                            </div><br>
                            ...
                            <div class="list-group">
                                <a href="https://dev.bekasikab.go.id/telagaasih/beranda/read_news/desaku-desaku"
                                    ...
                                    <div class="d-flex w-100 justify-content-between">
                                        ...
                                        <small>25 May 2021 10:37:41</small>
                                    </div>
                                    <small><i class="icofont-eye-alt"></i> Views: 67 | <i
