...
<head>
    ...
    <title>Struktur Organisasi - Website Resmi Kelurahan Telaga Asih</title>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-8 animate__animated animate__fadeInTopLeft animate__slow 2s">
                        <div class="col-sm-12">
                            ...
                            <hr />
                            <img src="../struktur/<?php echo $row['gambar'];?>" width="700px" height="700px" alt="" srcset="">
                            <p><br /></p>

                            <small><i class="icofont-ui-calendar"></i> Tanggal Update: 31 May 2021 11:39:14 </small>
                            <br>
                        </div>
                    </div><?php }?>
                    <!-- widget -->
